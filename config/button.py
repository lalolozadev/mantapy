...
plot_settings = (
    ...
    "}"
    "QPushButton:checked {"
    f"background-color: {verde1};"  # <--- Color cuando el botón está activo
    "}"
    "QPushButton:checked:hover {"
    f"background-color: {verde2};"  # Color cuando está activo y el mouse encima
    "}"
)